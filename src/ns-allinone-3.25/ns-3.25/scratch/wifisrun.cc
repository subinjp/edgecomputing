...
int main (int argc, char *argv[])
{
  ...
  for (uint32_t i = 0; i < nWifis; ++i)
    {
      ...
      sta.Create (nStas);
      //Static_Node.Add(sta.Get(nStas-1));
      ...
      ApplicationContainer clientApps = echoClient.Install(sta.Get(nStas-1));
 ...
 /* Address dest;
  ...
  AnimationInterface anim("wifisrun.xml");
