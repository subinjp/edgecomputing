...
//
  ...
  ApplicationContainer apps = echoServer.Install (n.Get (1));
...
//
  ...
  UdpTraceClientHelper client (serverAddress, port,"/home/sujith/ns-allinone-3.25/ns-3.25/scratch/Verbose_Jurassic_256.dat");
  ...
  csma.EnableAsciiAll (ascii.CreateFileStream ("udp_trace.tr"));
//
  // p2p captures in non-promiscuous mode
  csma.EnablePcapAll ("udp_trace", false);
